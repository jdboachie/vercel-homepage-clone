    ...
    <div className="grid gap-4 p-10 lg:p-12">
      <div className="h-fit grid gap-4">
        ...
        <div className="grid mt-4 text-sm">
          <div className="border items-center max-w-[330px] w-fit flex shadow-sm bg-background rounded-lg p-3 gap-4">
          ...
          <div className="relative grid place-items-center">
            ...
            <div className="absolute left-[calc(50%-8px)] top-[calc(50%-20px)] border bg-background p-2 rounded-full" data-version="v1">
          ...
          <div className="justify-self-end border border-dashed items-center max-w-[330px] w-fit flex shadow-sm bg-background rounded-lg p-3 gap-4">
            <div className="grid grow gap-1">
